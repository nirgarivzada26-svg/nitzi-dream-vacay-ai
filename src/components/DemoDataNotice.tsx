    ...
    >
      ...
      <div className="min-w-0 text-xs leading-relaxed">
        ...
        <p className="mt-0.5 text-[11px] opacity-90">
          NITZI עדיין לא מחוברת לספקי טיסות ומלונות אמיתיים. ההצעות שמוצגות כאן הן דוגמאות עיצוב
          בלבד — לא ניתן להזמין ולא מדובר במחירים אמיתיים. ברגע שנחבר את הספקים, יופיעו כאן רק דילים
          מאומתים.
        </p>
      </div>
    </div>
