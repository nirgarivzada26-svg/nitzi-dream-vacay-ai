  ...
  return [
    ...
    },
    {
      ...
      sections: [
        ...
        { heading: "יצירת קשר", body: [`תמיכה: ${support}. פניות משפטיות: ${val(c.legal_contact)}.`] },
      ],
    },
    {
      slug: "cookies",
    ...
    },
    {
      ...
      sections: [
        ...
        { heading: "מגבלות ידועות", body: [
          "רכיבי מפה ואנימציה מסוימים עשויים להיות מוגבלים בקוראי מסך. אנו פועלים לשיפורם.",
        ] },
        { heading: "פנייה לרכז הנגישות", body: [`ניתן לדווח על בעיית נגישות בכתובת ${val(c.support_email)} או בטלפון ${val(c.support_phone)}.`] },
      ],
    },
    {
      slug: "refunds",
    ...
    },
    {
      ...
      sections: [
        ...
        { heading: "בריאות וביטוח", body: [
          "מומלץ לרכוש ביטוח נסיעות. דרישות חיסון או בריאות ביעד הן באחריות הנוסע.",
        ] },
        { heading: "כבודה ושינויים", body: [
